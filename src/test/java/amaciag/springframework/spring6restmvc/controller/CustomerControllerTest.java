...
class CustomerControllerTest {
    ...
    void updateCustomer() throws Exception {
        ...
        mockMvc.perform(put(CustomerController.CUSTOMER_URI_ID, customer.getId())
    ...
    void deleteCustomer() throws Exception {
        ...
        mockMvc.perform(delete(CustomerController.CUSTOMER_URI_ID, customer.getId())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
    ...
    void patchCustomer() throws Exception {
        ...
        mockMvc.perform(patch(CustomerController.CUSTOMER_URI_ID, customer.getId())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void getCustomerById() throws Exception {
        ...
        mockMvc.perform(get(CustomerController.CUSTOMER_URI_ID, testCustomer.getId()).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
